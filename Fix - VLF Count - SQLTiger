--I modified little to use OLA Script for backup and commented out changing recovery model.
--Original script can be found at below location.
...
BEGIN
	...
	PRINT 'EXECUTE DBATasks.dbo.DatabaseBackup
@Databases = [' + @dbname + '],
@Directory = NULL,
@BackupType = ''LOG'',
@ChangeBackupType = ''Y'',
