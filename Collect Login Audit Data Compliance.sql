...
BEGIN
    ...
    BEGIN
        ...
        WHERE te.name IN('Audit Addlogin Event', 'Audit Add DB User Event', 'Audit Add Member to DB Role Event', 'Audit Add Login to Server Role Event', 'Audit Schema Object GDR Event', 'Audit Database Object GDR Event')
    ...
    BEGIN
        ...
        IF EXISTS (SELECT 1 FROM tblAuditLogins)
        BEGIN
